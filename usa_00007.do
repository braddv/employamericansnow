...
quietly infix                 ///
  ...
  int     ind        90-93    ///
  byte    classwkr   94-94    ///
  byte    classwkrd  95-96    ///
  byte    uhrswork   97-98    ///
  byte    looking    99-99    ///
  byte    availble   100-100  ///
  long    inctot     101-107  ///
  long    ftotinc    108-114  ///
  long    incwage    115-120  ///
  long    incwelfr   121-125  ///
  int     poverty    126-128  ///
  int     age_head   129-131  ///
  using `"/Users/braddv/Desktop/BERNIE/usa_00007.dat"'
...
label define met2013_lbl 32420 `"Mayag¸ez, PR"', add
...
label define met2013_lbl 41900 `"San Germ·n, PR"', add
